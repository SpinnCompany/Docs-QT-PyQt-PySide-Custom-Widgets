...
- [Install](/Introduction/installation) the custom widgets module if not installed:

## Create your project using the project maker
- If you have not created your Custom Widgets project, [create a new project](/API-Reference/ProjectMaker)

### Inside your project:

The files that you will be customizing here are the "main.py", "Json styles" and the "QSS/defaultStyle.scss". 
...
Now you can add you themes inside the "CustomTheme" object a shown below (or similar):
```json
{
    "QMainWindow": [
        {
...
### `Other-variables` in each custom theme

* These allow you to define **custom SCSS variables** (like `$PRIMARY_SHADOW`, `$CARD_RADIUS`, `$FOOTER_BG`, etc.) in the theme JSON.
