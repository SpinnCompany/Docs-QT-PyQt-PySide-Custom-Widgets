...
<Zoomable src={useBaseUrl('/img/showcase/liquidgauge.gif')} alt="QCustomLiquidGauge" />
...
<Zoomable src={useBaseUrl('/img/showcase/liquidgauge-dark.gif')} alt="QCustomLiquidGauge in dark theme" />
