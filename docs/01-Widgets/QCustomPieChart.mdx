...
<Zoomable src={useBaseUrl('/img/showcase/piechart.gif')} alt="QCustomPieChart" />
...
<Zoomable src={useBaseUrl('/img/showcase/piechart-dark.gif')} alt="QCustomPieChart in dark theme" />
