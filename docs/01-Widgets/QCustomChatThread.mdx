...
<Zoomable src={useBaseUrl('/img/showcase/chatthread.png')} alt="QCustomChatThread" />
...
<Zoomable src={useBaseUrl('/img/showcase/chatthread-dark.png')} alt="QCustomChatThread in dark theme" />
...
Colours come from the design tokens, so they follow the active theme. Roles used: `accent`, `on-primary`, `on-secondary`, `on-surface`, `on-surface-muted`, `primary`, `secondary`, `surface-muted`.

See [Design tokens](../02-Theming/DesignTokens.md).

## Related

[QCustomChatBubble](QCustomChatBubble.mdx) · [QCustomChatDivider](QCustomChatDivider.mdx) · [QCustomChatInput](QCustomChatInput.mdx) · [QCustomChatList](QCustomChatList.mdx) · [QCustomChatListItem](QCustomChatListItem.mdx) · [QCustomMessageStatus](QCustomMessageStatus.mdx) · [QCustomReactionBar](QCustomReactionBar.mdx) · [QCustomTypingIndicator](QCustomTypingIndicator.mdx)
