...
| `border(*args, **kwargs)` |  |
| `boxSize(*args, **kwargs)` |  |
| `cacheEnabled(*args, **kwargs)` |  |
| `clearCache()` | Clear the QR code cache. |
| `colorMask(*args, **kwargs)` |  |
| `copyToClipboard()` | Copy the QR code to clipboard. |
| `data(*args, **kwargs)` |  |
| `embedImage(*args, **kwargs)` |  |
| `embeddedImageIcon(*args, **kwargs)` |  |
| `errorCorrection(*args, **kwargs)` |  |
...
| `gradientEndColor(*args, **kwargs)` |  |
| `gradientStartColor(*args, **kwargs)` |  |
| `moduleDrawer(*args, **kwargs)` |  |
