...
<Zoomable src={useBaseUrl('/img/showcase/reactionbar.png')} alt="QCustomReactionBar" />
...
<Zoomable src={useBaseUrl('/img/showcase/reactionbar-dark.png')} alt="QCustomReactionBar in dark theme" />
