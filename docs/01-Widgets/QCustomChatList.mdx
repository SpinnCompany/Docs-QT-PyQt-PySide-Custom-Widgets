...
<Zoomable src={useBaseUrl('/img/showcase/chatlist.gif')} alt="QCustomChatList" />
...
<Zoomable src={useBaseUrl('/img/showcase/chatlist-dark.gif')} alt="QCustomChatList in dark theme" />
...
Colours come from the design tokens, so they follow the active theme. Roles used: `accent`, `on-primary`, `on-surface`, `on-surface-muted`, `primary`, `success`, `surface`.

See [Design tokens](../02-Theming/DesignTokens.md).

## Related

[QCustomChatBubble](QCustomChatBubble.mdx) · [QCustomChatDivider](QCustomChatDivider.mdx) · [QCustomChatInput](QCustomChatInput.mdx) · [QCustomChatListItem](QCustomChatListItem.mdx) · [QCustomChatThread](QCustomChatThread.mdx) · [QCustomMessageStatus](QCustomMessageStatus.mdx) · [QCustomReactionBar](QCustomReactionBar.mdx) · [QCustomTypingIndicator](QCustomTypingIndicator.mdx)
