...
<Zoomable src={useBaseUrl('/img/showcase/barchart.gif')} alt="QCustomBarChart" />
...
<Zoomable src={useBaseUrl('/img/showcase/barchart-dark.gif')} alt="QCustomBarChart in dark theme" />
...
[QCustomAreaChart](QCustomAreaChart.mdx) · [QCustomBeeswarm](QCustomBeeswarm.mdx) · [QCustomBubbleChart](QCustomBubbleChart.mdx) · [QCustomCandlestickChart](QCustomCandlestickChart.mdx) · [QCustomCompass](QCustomCompass.mdx) · [QCustomCompassDial](QCustomCompassDial.mdx) · [QCustomDivergingBarChart](QCustomDivergingBarChart.mdx) · [QCustomDonut](QCustomDonut.mdx)
