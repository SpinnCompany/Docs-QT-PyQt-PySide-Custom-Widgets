...
![QCustomHamburgerMenu](/img/showcase/hamburgermenu.gif)
...
| Method | Description |
|---|---|
| `acrylicBlurRadius(*args, **kwargs)` | Acrylic blur radius. |
| `acrylicEnabled(*args, **kwargs)` | Acrylic enabled. |
| `acrylicLuminosityColor(*args, **kwargs)` | Acrylic luminosity color. |
| `acrylicNoiseOpacity(*args, **kwargs)` | Acrylic noise opacity. |
| `acrylicTintColor(*args, **kwargs)` | Acrylic tint color. |
...
| `autoHide(*args, **kwargs)` | Auto hide. |
| `backgroundColor(*args, **kwargs)` | Background color. |
| `center(*args, **kwargs)` | Center. |
...
| `getWidget(name: str) -> PySide6.QtWidgets.QWidget` | Return the widget. |
| `hideButtonName(*args, **kwargs)` | Hide the button name. |
| `hideMenu(duration=None)` | Animate the menu closing away from center. |
| `margin(*args, **kwargs)` | Margin. |
| `menuHeight(*args, **kwargs)` | Menu height. |
| `menuWidth(*args, **kwargs)` | Menu width. |
| `overlayColor(*args, **kwargs)` | Overlay color. |
...
| `showButtonName(*args, **kwargs)` | Show the button name. |
| `showMenu()` | Animate the menu opening towards center. |
| `sizeWrap(*args, **kwargs)` | Size wrap. |
