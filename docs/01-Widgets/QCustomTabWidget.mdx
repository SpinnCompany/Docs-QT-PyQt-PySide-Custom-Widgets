...
<Zoomable src={useBaseUrl('/img/showcase/tabwidget.gif')} alt="QCustomTabWidget" />
...
<Zoomable src={useBaseUrl('/img/showcase/tabwidget-dark.gif')} alt="QCustomTabWidget in dark theme" />
...
Colours come from the design tokens, so they follow the active theme. Roles used: `surface`, `on-surface`, `outline`, `accent`, `on-primary`.
