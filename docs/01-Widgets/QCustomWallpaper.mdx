...
<Zoomable src={useBaseUrl('/img/showcase/wallpaper.png')} alt="QCustomWallpaper" />
...
<Zoomable src={useBaseUrl('/img/showcase/wallpaper-dark.png')} alt="QCustomWallpaper in dark theme" />
...
[QCustomCoverFlow](QCustomCoverFlow.mdx) · [QCustomImageViewer](QCustomImageViewer.mdx) · [QCustomMediaGrid](QCustomMediaGrid.mdx) · [QCustomMediaTimeline](QCustomMediaTimeline.mdx) · [QCustomPlayerBar](QCustomPlayerBar.mdx) · [QCustomVideoPlayer](QCustomVideoPlayer.mdx) · [QCustomVoiceMessage](QCustomVoiceMessage.mdx)
