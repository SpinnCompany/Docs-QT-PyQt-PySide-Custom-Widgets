...
<Zoomable src={useBaseUrl('/img/showcase/minibarchart.png')} alt="QCustomMiniBarChart" />
...
<Zoomable src={useBaseUrl('/img/showcase/minibarchart-dark.png')} alt="QCustomMiniBarChart in dark theme" />
