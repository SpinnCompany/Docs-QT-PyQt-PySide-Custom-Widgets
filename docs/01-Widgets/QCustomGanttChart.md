...
![QCustomGanttChart screenshot](/img/showcase/ganttchart.png)
...
```python
QCustomGanttChart(parent=None, rows=None)
```
...
![QCustomGanttChart dark](/img/showcase/ganttchart-dark.png)
