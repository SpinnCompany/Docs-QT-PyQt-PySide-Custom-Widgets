...
<Zoomable src={useBaseUrl('/img/showcase/featuredicon.png')} alt="QCustomFeaturedIcon" />
...
<Zoomable src={useBaseUrl('/img/showcase/featuredicon-dark.png')} alt="QCustomFeaturedIcon in dark theme" />
...
Colours come from the design tokens, so they follow the active theme. Roles used: `accent`, `surface`.
