...
![QCustomRadialGauge screenshot](/img/showcase/radialgauge.png)
...
```python
QCustomRadialGauge(parent=None, value=55.0, minimum=0.0, maximum=100.0, gaugeStyle='needle')
```
...
![QCustomRadialGauge dark](/img/showcase/radialgauge-dark.png)
