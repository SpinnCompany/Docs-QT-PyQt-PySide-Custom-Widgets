...
<Zoomable src={useBaseUrl('/img/showcase/slidemenu.gif')} alt="QCustomSlideMenu" />
...
<Zoomable src={useBaseUrl('/img/showcase/slidemenu-dark.gif')} alt="QCustomSlideMenu in dark theme" />
