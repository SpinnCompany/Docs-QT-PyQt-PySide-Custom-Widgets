...
<Zoomable src={useBaseUrl('/img/showcase/compass.png')} alt="QCustomCompass" />
...
<Zoomable src={useBaseUrl('/img/showcase/compass-dark.png')} alt="QCustomCompass in dark theme" />
...
[QCustomAreaChart](QCustomAreaChart.mdx) · [QCustomBarChart](QCustomBarChart.mdx) · [QCustomBeeswarm](QCustomBeeswarm.mdx) · [QCustomBubbleChart](QCustomBubbleChart.mdx) · [QCustomCandlestickChart](QCustomCandlestickChart.mdx) · [QCustomCompassDial](QCustomCompassDial.mdx) · [QCustomDivergingBarChart](QCustomDivergingBarChart.mdx) · [QCustomDonut](QCustomDonut.mdx)
