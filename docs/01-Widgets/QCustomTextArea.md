...
![QCustomTextArea screenshot](/img/showcase/textarea.png)
...
```python
QCustomTextArea(parent=None, placeholder='', maxLength=0)
```
...
![QCustomTextArea dark](/img/showcase/textarea-dark.png)
...
```bash
python examples/PySide6/QCustomTextArea/main.py
```
