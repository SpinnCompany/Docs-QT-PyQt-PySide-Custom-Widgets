...
<Zoomable src={useBaseUrl('/img/showcase/avatar.png')} alt="QCustomAvatar" />
...
<Zoomable src={useBaseUrl('/img/showcase/avatar-dark.png')} alt="QCustomAvatar in dark theme" />
...
[AnalogGaugeWidget](AnalogGaugeWidget.md) · [QCustomAgendaList](QCustomAgendaList.mdx) · [QCustomAlert](QCustomAlert.md) · [QCustomAvatarGroup](QCustomAvatarGroup.mdx) · [QCustomBadge](QCustomBadge.md) · [QCustomCard](QCustomCard.md) · [QCustomChip](QCustomChip.mdx) · [QCustomClockLabel](QCustomClockLabel.mdx)
