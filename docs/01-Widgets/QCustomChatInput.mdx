...
<Zoomable src={useBaseUrl('/img/showcase/chatinput.png')} alt="QCustomChatInput" />
...
<Zoomable src={useBaseUrl('/img/showcase/chatinput-dark.png')} alt="QCustomChatInput in dark theme" />
