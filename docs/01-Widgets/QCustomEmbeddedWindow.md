...
```python
QCustomEmbeddedWindow(parent, pos=None, title='New window', icon=None, borderRadius=10, headerHeight=25, animationDuration=500, showForm=None, addWidget=None)
```
...
![QCustomEmbeddedWindow dark](/img/showcase/embeddedwindow-dark.png)
...
```bash
python examples/PySide6/QCustomEmbeddedWindow/main.py
```
