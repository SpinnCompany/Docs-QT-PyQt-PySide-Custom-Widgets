...
Pro is licensed software and is **not installable from PyPI** — the name there is a pointer package with no widgets in it. Licence holders download the wheel from their account:
