...
![QCustomDivergingBarChart screenshot](/img/showcase/divergingbarchart.png)
...
```python
QCustomDivergingBarChart(parent=None, up=None, down=None, labels=None)
```
...
![QCustomDivergingBarChart dark](/img/showcase/divergingbarchart-dark.png)
