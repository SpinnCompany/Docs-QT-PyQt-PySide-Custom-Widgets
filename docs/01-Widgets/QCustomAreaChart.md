---
title: QCustomAreaChart
description: Area chart implementation using the modular architecture.
mdx:
  format: md
---
...
|---|---|
| **Tier** | Free (GPLv3) |
| **Import** | `from Custom_Widgets.QCustomCharts.QCustomAreaChart import QCustomAreaChart` |
