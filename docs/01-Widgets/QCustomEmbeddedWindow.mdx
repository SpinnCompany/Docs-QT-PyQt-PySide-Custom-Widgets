...
<Zoomable src={useBaseUrl('/img/showcase/embeddedwindow.gif')} alt="QCustomEmbeddedWindow" />
...
<Zoomable src={useBaseUrl('/img/showcase/embeddedwindow-dark.gif')} alt="QCustomEmbeddedWindow in dark theme" />
...
| `borderRadius(*args, **kwargs)` | Border radius. |
| `closed(...)` | Closed. |
| `headerHeight(*args, **kwargs)` | Header height. |
...
| `title()` | Title. |
| `titleText(*args, **kwargs)` | Title text. |
...
[QCustomAccordion](QCustomAccordion.mdx) · [QCustomCardStack](QCustomCardStack.mdx) · [QCustomCarousel](QCustomCarousel.md) · [QCustomComponent](QCustomComponent.md) · [QCustomComponentContainer](QCustomComponentContainer.md) · [QCustomComponentLoader](QCustomComponentLoader.md) · [QCustomFlowLayout](QCustomFlowLayout.md) · [QCustomFlowWidget](QCustomFlowWidget.mdx)
