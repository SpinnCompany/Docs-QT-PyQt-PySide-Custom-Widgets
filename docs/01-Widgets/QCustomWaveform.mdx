...
<Zoomable src={useBaseUrl('/img/showcase/waveform.png')} alt="QCustomWaveform" />
...
<Zoomable src={useBaseUrl('/img/showcase/waveform-dark.png')} alt="QCustomWaveform in dark theme" />
