...
<Zoomable src={useBaseUrl('/img/showcase/mapview.png')} alt="QCustomMapView" />
...
<Zoomable src={useBaseUrl('/img/showcase/mapview-dark.png')} alt="QCustomMapView in dark theme" />
