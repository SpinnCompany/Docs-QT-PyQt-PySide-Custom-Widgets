---
title: QCustomVerticalSeparator
...
![QCustomVerticalSeparator](/img/showcase/verticalseparator.png)
...
|---|---|
| **Tier** | Free (GPLv3) |
| **Import** | `from Custom_Widgets.QCustomVerticalSeparator import QCustomVerticalSeparator` |
...
widget = QCustomVerticalSeparator()
```
...
![QCustomVerticalSeparator in dark theme](/img/showcase/verticalseparator-dark.png)
