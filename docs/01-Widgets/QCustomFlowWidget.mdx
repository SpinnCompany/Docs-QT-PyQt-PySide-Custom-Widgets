...
<Zoomable src={useBaseUrl('/img/showcase/flowwidget.gif')} alt="QCustomFlowWidget" />
...
<Zoomable src={useBaseUrl('/img/showcase/flowwidget-dark.gif')} alt="QCustomFlowWidget in dark theme" />
...
| `animationEasingCurve` | `string` | `OutCubic` |
| `equalDistribution` | `bool` | `True` |
| `autoFillWidth` | `bool` | `False` |
| `autoFillHeight` | `bool` | `False` |
| `justifySpacing` | `bool` | `False` |
