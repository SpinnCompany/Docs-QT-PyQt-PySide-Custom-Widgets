...
<Zoomable src={useBaseUrl('/img/showcase/verificationcode.gif')} alt="QCustomVerificationCode" />
...
<Zoomable src={useBaseUrl('/img/showcase/verificationcode-dark.gif')} alt="QCustomVerificationCode in dark theme" />
