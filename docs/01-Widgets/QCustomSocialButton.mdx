...
<Zoomable src={useBaseUrl('/img/showcase/socialbutton.gif')} alt="QCustomSocialButton" />
...
<Zoomable src={useBaseUrl('/img/showcase/socialbutton-dark.gif')} alt="QCustomSocialButton in dark theme" />
...
Colours come from the design tokens, so they follow the active theme. Roles used: `surface`.
...
[QCustomActionButton](QCustomActionButton.mdx) · [QCustomCopyButton](QCustomCopyButton.mdx) · [QCustomQPushButton](QCustomQPushButton.md) · [QCustomQPushButtonGroup](QCustomQPushButtonGroup.md) · [QCustomRainbowButton](QCustomRainbowButton.mdx) · [QCustomThemeDarkLightToggle](QCustomThemeDarkLightToggle.mdx) · [QCustomTileButton](QCustomTileButton.mdx)
