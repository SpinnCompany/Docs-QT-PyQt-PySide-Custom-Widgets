...
![QCustomPieChart screenshot](/img/showcase/piechart.png)

`QCustomPieChart` — Pie chart implementation using the modular architecture.
...
![QCustomPieChart dark](/img/showcase/piechart-dark.png)
