---
title: QCustomBarChart
description: Bar chart implementation using the modular architecture.
mdx:
  format: md
---
...
![QCustomBarChart](/img/showcase/barchart.gif)
...
|---|---|
| **Tier** | Free (GPLv3) |
| **Import** | `from Custom_Widgets.QCustomCharts.QCustomBarChart import QCustomBarChart` |
...
![QCustomBarChart in dark theme](/img/showcase/barchart-dark.gif)
