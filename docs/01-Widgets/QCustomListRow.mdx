...
<Zoomable src={useBaseUrl('/img/showcase/listrow.png')} alt="QCustomListRow" />
...
<Zoomable src={useBaseUrl('/img/showcase/listrow-dark.png')} alt="QCustomListRow in dark theme" />
