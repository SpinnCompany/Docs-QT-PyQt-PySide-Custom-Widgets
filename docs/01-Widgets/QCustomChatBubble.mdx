...
<Zoomable src={useBaseUrl('/img/showcase/chatbubble.png')} alt="QCustomChatBubble" />
...
<Zoomable src={useBaseUrl('/img/showcase/chatbubble-dark.png')} alt="QCustomChatBubble in dark theme" />
