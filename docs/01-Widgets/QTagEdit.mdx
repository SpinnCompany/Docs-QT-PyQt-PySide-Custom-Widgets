...
<Zoomable src={useBaseUrl('/img/showcase/tagedit.gif')} alt="QTagEdit" />
...
|---|---|
| **Tier** | Free (GPLv3) |
| **Import** | `from Custom_Widgets.QCustomTagEdit import QTagEdit` |
...
<Zoomable src={useBaseUrl('/img/showcase/tagedit-dark.gif')} alt="QTagEdit in dark theme" />
...
Colours come from the design tokens, so they follow the active theme. Roles used: `on-secondary`, `on-surface`, `outline`, `secondary`, `surface`.
