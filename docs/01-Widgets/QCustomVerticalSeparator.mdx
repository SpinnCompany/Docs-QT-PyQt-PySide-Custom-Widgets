...
<Zoomable src={useBaseUrl('/img/showcase/verticalseparator.png')} alt="QCustomVerticalSeparator" />
...
<Zoomable src={useBaseUrl('/img/showcase/verticalseparator-dark.png')} alt="QCustomVerticalSeparator in dark theme" />
