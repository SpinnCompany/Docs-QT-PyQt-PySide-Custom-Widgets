...
<Zoomable src={useBaseUrl('/img/showcase/popover.png')} alt="QCustomPopover" />
...
<Zoomable src={useBaseUrl('/img/showcase/popover-dark.png')} alt="QCustomPopover in dark theme" />
