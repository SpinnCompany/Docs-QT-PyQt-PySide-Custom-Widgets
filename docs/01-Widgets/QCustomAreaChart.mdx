...
<Zoomable src={useBaseUrl('/img/showcase/areachart.gif')} alt="QCustomAreaChart" />
...
<Zoomable src={useBaseUrl('/img/showcase/areachart-dark.gif')} alt="QCustomAreaChart in dark theme" />
...
[QCustomBarChart](QCustomBarChart.mdx) · [QCustomBeeswarm](QCustomBeeswarm.mdx) · [QCustomBubbleChart](QCustomBubbleChart.mdx) · [QCustomCandlestickChart](QCustomCandlestickChart.mdx) · [QCustomCompass](QCustomCompass.mdx) · [QCustomCompassDial](QCustomCompassDial.mdx) · [QCustomDivergingBarChart](QCustomDivergingBarChart.mdx) · [QCustomDonut](QCustomDonut.mdx)
