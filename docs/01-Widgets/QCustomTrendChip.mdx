...
<Zoomable src={useBaseUrl('/img/showcase/trendchip.png')} alt="QCustomTrendChip" />
...
<Zoomable src={useBaseUrl('/img/showcase/trendchip-dark.png')} alt="QCustomTrendChip in dark theme" />
