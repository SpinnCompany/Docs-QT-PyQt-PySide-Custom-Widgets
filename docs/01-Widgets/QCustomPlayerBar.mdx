...
<Zoomable src={useBaseUrl('/img/showcase/playerbar.png')} alt="QCustomPlayerBar" />
...
<Zoomable src={useBaseUrl('/img/showcase/playerbar-dark.png')} alt="QCustomPlayerBar in dark theme" />
...
[QCustomCoverFlow](QCustomCoverFlow.mdx) · [QCustomImageViewer](QCustomImageViewer.mdx) · [QCustomMediaGrid](QCustomMediaGrid.mdx) · [QCustomMediaTimeline](QCustomMediaTimeline.mdx) · [QCustomVideoPlayer](QCustomVideoPlayer.mdx) · [QCustomVoiceMessage](QCustomVoiceMessage.mdx) · [QCustomWallpaper](QCustomWallpaper.mdx)
