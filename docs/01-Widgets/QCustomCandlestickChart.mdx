...
`QCustomCandlestickChart` ships in **Custom Widgets Pro**. It is not part of the free GPLv3 package from **2.6.0** onward — the free package keeps the import path so Qt Designer forms still load, and installing Pro activates the widget with no code change. Releases up to 2.5.0 included it under the GPLv3.
...
<Zoomable src={useBaseUrl('/img/showcase/candlestickchart.png')} alt="QCustomCandlestickChart" />
...
<Zoomable src={useBaseUrl('/img/showcase/candlestickchart-dark.png')} alt="QCustomCandlestickChart in dark theme" />
...
[QCustomAreaChart](QCustomAreaChart.mdx) · [QCustomBarChart](QCustomBarChart.mdx) · [QCustomBeeswarm](QCustomBeeswarm.mdx) · [QCustomBubbleChart](QCustomBubbleChart.mdx) · [QCustomCompass](QCustomCompass.mdx) · [QCustomCompassDial](QCustomCompassDial.mdx) · [QCustomDivergingBarChart](QCustomDivergingBarChart.mdx) · [QCustomDonut](QCustomDonut.mdx)
