...
<Zoomable src={useBaseUrl('/img/showcase/rainbowbutton.gif')} alt="QCustomRainbowButton" />
...
<Zoomable src={useBaseUrl('/img/showcase/rainbowbutton-dark.gif')} alt="QCustomRainbowButton in dark theme" />
...
[QCustomActionButton](QCustomActionButton.mdx) · [QCustomCopyButton](QCustomCopyButton.mdx) · [QCustomQPushButton](QCustomQPushButton.md) · [QCustomQPushButtonGroup](QCustomQPushButtonGroup.md) · [QCustomSocialButton](QCustomSocialButton.mdx) · [QCustomThemeDarkLightToggle](QCustomThemeDarkLightToggle.mdx) · [QCustomTileButton](QCustomTileButton.mdx)
