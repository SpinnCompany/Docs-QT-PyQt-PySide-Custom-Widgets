...
<Zoomable src={useBaseUrl('/img/showcase/numbercounter.gif')} alt="QCustomNumberCounter" />
...
<Zoomable src={useBaseUrl('/img/showcase/numbercounter-dark.gif')} alt="QCustomNumberCounter in dark theme" />
